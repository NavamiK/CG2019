...
VInstance::VInstance(VCone* content)
{
    archetype = content;
...
VCone* VInstance::content() {
    /* TODO */
    return archetype;
}

void VInstance::reset() {
    /* TODO */
    transformation = Matrix::identity();
    invTrans = transformation;
    //computeBounds();
...
void VInstance::translate(const Vector& t) {
    /* TODO */
    Matrix tMatrix{
...
void VInstance::rotate(const Vector& nnaxis, float angle) {
    /* TODO */
...
void VInstance::scale(const Vector& s) {
    /* TODO */  
    Matrix tMatrix{
...
std::tuple<bool, float, float> VInstance::intersect(const Ray& ray) const {
    /* TODO */ 
